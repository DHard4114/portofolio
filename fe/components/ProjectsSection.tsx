 ...
 * @description State-of-the-art project showcase with 3D tilt, HUD navigation, and holographic modals.
                ...
                <div className="relative z-10 space-y-6">
                    <div>
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-[9px] font-mono text-neutral-600">{project.year}</span>
                        </div>
